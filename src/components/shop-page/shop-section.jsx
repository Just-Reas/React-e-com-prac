      ...
      <div className="containerSup">
        ...
        <div className={styles.shopTableBox}>
          <a href="#" className={styles.shopTableMen}>
            ...
            <img
              className={styles.shopTableMenPng}
              src="./shop-page/men.png"
              alt="men"
            />
          </a>
          <a href="#" className={styles.shopTableWomen}>
            <img
              className={styles.shopTableWomenPng}
              src="./shop-page/women.png"
              alt="women"
            />
          ...
          <a href="#" className={styles.shopTableOuterwear}>
            ...
            <img
              className={styles.shopTableOuterwearPng}
              src="./shop-page/outerwear.png"
              alt="outerwear"
            />
          </a>
          <a href="#" className={styles.shopTableOutfits}>
            ...
            <img
              className={styles.shopTableOutfitsPng}
              src="./shop-page/outfits.png"
              alt="outfits"
            />
          </a>
          <a href="#" className={styles.shopTableShoes}>
            ...
            <img
              className={styles.shopTableShoesPng}
              src="./shop-page/shoes.png"
              alt="Shoes"
            />
          </a>
        </div>
