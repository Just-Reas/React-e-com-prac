    ...
    <>
      <div className="header-discount">
        <div className="container">
          <div className="header-discount__inner">
            <div className="header-discount__text">
              Sign up and get 20% off to your first order.{" "}
              <a href="#">Sign Up Now</a>
            </div>

            <button className="header-discount__button">
              <svg
                width="14"
                height="14"
                viewBox="0 0 14 14"
          ...
          <div className="header-menu-inner">
            <div className="header-menu-bar">
              ...
              <div className="header-menu-buttons">
                <button className="header-menu-buttons__buy">
                  <svg
                    className="header-menu-buttons__buy__svg"
                    width="24"
                    height="24"
                    viewBox="0 0 24 24"
                    fill="none"
                ...
                <button className="header-menu-buttons__profile">
                  <svg
                    className="header-menu-buttons__profile__svg"
                    width="24"
                    height="24"
                    viewBox="0 0 24 24"
                    fill="none"
